...
@interface DLSingleLinkListTest : XCTestCase

@property(nonatomic, strong) DLSingleLinkList * list;

@end

@implementation DLSingleLinkListTest

- (void)setUp {
    self.list = [[DLSingleLinkList alloc] init];
}
